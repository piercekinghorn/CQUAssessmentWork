...
@NamedQueries ({
    ...
    @NamedQuery(name = "findVehicleByRef", query = "SELECT v FROM Vehicle v WHERE v.refId= :ReferenceId"),
})
...
public class Vehicle implements Serializable{
    ...
    //Constructor
    public Vehicle(Long id, String refId, String Make, String Model, String DriveType, String Colour,
